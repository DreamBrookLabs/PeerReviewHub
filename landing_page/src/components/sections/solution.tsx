...
const features = [
  {
    ...
    content: (
      <>
        <Safari
          src={"/PeerReviewHub_process.png"}
          url="https://PeerReviewHub.tech"
...
export default function Component() {
  return (
    <Section
      title="Solution"
      subtitle="AI-Powered Open Peer Review SaaS"
      description="Traditional Peer Review SaaS is outdated. Our platform combine the best of both scientific publication practices and AI solutions to provide unique and efficient scientific publication pipeline."
