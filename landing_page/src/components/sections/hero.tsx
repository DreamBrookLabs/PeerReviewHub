...
function HeroPill() {
  return (
    <motion.a
      href="/blog/introducing-peerreviewhub"
    ...
    >
      ...
      <p className="text-xs font-medium text-primary sm:text-sm">
        Introducing PeerReviewHub.tech
      </p>
      <svg
        width="12"
        height="12"
...
function HeroTitles() {
  return (
    <div className="flex w-full max-w-2xl flex-col space-y-4 overflow-hidden pt-8">
      ...
      >
        {["AI-Powered Platform", "for Open Peer Review"].map((text, index) => (
          <motion.span
            key={index}
      ...
      >
        The Immune System for Science of the 21st Century.
      </motion.p>
    </div>
  );
}
  ...
  return (
    ...
    >
      <HeroVideoDialog
        ...
        videoSrc="https://youtu.be/GEZJPqxpQLc?si=li5UH6C8sOabb83Q"
        thumbnailSrc="/PeerReviewHub_process.png"
